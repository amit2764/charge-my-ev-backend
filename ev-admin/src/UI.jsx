...
export const Input = ({ label, ...props }) => (
  <div className="mb-4 w-full text-left">
    ...
    <input
      className="w-full p-2.5 bg-white border border-gray-300 rounded-md text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
      {...props} 
    />
  </div>
);
